...
exports.repeat = function (count) {
  ...
  return {
    test: function (block) {
      return block.getType() === 'controls_repeat';
    },
...
exports.repeatSimpleBlock = function (count) {
  return {
    test: function (block) {
      return block.getType() === 'controls_repeat_simplified';
    },
  ...
  return [
    {
      ...
      test: function (userBlock) {
        if (userBlock.getType() === node.getAttribute('type')) {
...
exports.blocksMatch = function (blockA, blockB) {
  var typesMatch = blockA.getType() === blockB.getType();
...
var fieldsMatch = function (fieldA, fieldB) {
  return (
    fieldB.getName() === fieldA.getName() &&
    fieldB.getValue() === fieldA.getValue()
  );
};
