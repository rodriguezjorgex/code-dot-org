  ...
  tests: [
    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          $('#propertyRowContainer input:eq(0)').val(),
          'screen1',
    ...
    },
    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          $('#designModeViz').children().length,
          2,
          'has two screen divs'
        );
        assert.equal(
          screenSelector.options.length,
          4,
          'has four options in dropdown'
        );
        ...
        assert.equal(
          buttonParent.parentNode.getAttribute('id'),
          'design_screen2'
        );

        // Change to screen1 using dropdown
        ReactTestUtils.Simulate.change(
          document.getElementById('screenSelector'),
    ...
    },
    {
      ...
      runBeforeClick: function (assert) {
        ...
        var deleteButton = $('#design-properties button').eq(0);
        assert.equal(
          deleteButton.text(),
          'Delete',
          'delete button on screen 2 should say delete'
        );

        // Both screen 1 and 2 should have delete buttons
        $('#screenSelector').val('screen1');
        ReactTestUtils.Simulate.change(screenSelector);
        deleteButton = $('#design-properties button').eq(0);
        validatePropertyRow(0, 'id', 'screen1', assert);
        assert.equal(
          deleteButton.text(),
          'Delete',
          'delete button on screen 1 should say delete'
        );
        ...
        assert.equal(
          $('#design-properties button').eq(0).text(),
          'Yes',
          'first button should be yes'
        );
        assert.equal(
          $('#design-properties button').eq(1).text(),
          'No',
          'second button should be no'
        );
        ...
        ReactTestUtils.Simulate.click($('#design-properties button').eq(0)[0]);
    ...
    },
    {
      ...
      runBeforeClick: function (assert) {
        ...
        tickWrapper.runOnAppTick(Applab, 2, function () {
          assert.equal(
            $('#divApplab').is(':visible'),
            true,
            'divApplab is visible'
          );

          assert.equal(
            $('#divApplab #screen1').is(':visible'),
            false,
            'screen1 is not visible'
          );
          assert.equal(
            $('#divApplab #screen2').is(':visible'),
            true,
            'screen2 is visible'
          );

          assert.equal(
            $('#divApplab #button1').is(':visible'),
            false,
            'button1 is not visible'
          );
          assert.equal(
            $('#divApplab #button2').is(':visible'),
            true,
            'button2 is visible'
          );

          assert.equal(
            $('#divApplab #button1').parent().attr('id'),
            'screen1',
            'screen1 is parent of button1'
          );
          assert.equal(
            $('#divApplab #button2').parent().attr('id'),
            'screen2',
            'screen2 is parent of button2'
          );
    ...
    },
    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          $('#design_screen1')[0].style.display === 'none',
          true,
          'screen 1 hidden'
        );
        assert.equal(
          $('#design_screen2')[0].style.display === 'none',
          false,
          'screen 2 visible'
        );
        ...
        assert.equal(
          $('#divApplab #screen1')[0].style.display === 'none',
          true,
          'screen 1 hidden'
        );
        assert.equal(
          $('#divApplab #screen2')[0].style.display === 'none',
          false,
          'screen 2 visible'
        );
    ...
    {
      description:
        "switching to code mode while running in design mode doesn't change screen",
      editCode: true,
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          ...
          0,
          'transparency layer not visible when designing'
        );
        ...
        tickWrapper.runOnAppTick(Applab, 2, function () {
          ...
          assert.equal(
            $('#divApplab #screen1')[0].style.display === 'none',
            true,
            'screen 1 hidden after run'
          );
          assert.equal(
            $('#divApplab #screen2')[0].style.display === 'none',
            false,
            'screen 2 visible after run'
          );
          assert.equal(
            $('#design-mode-dimmed').length,
            1,
            'transparency layer visible when running'
          );
          ...
          assert.equal(
            $('#divApplab #screen1')[0].style.display === 'none',
            true,
            'screen 1 hidden after code mode'
          );
          assert.equal(
            $('#divApplab #screen2')[0].style.display === 'none',
            false,
            'screen 2 visible after code mode'
          );
...

    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert(
          $(outerDiv).hasClass('ui-resizable'),
          'child is outer resizable div'
        );
...

    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          screenElement.style.backgroundSize,
          '320px 450px',
          'image stretched'
        );
...

    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          $('#screenSelector').children().eq(3).text(),
          'New screen...'
        );
    ...
    },
    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          ...
          'Duplicate',
          'duplicate button on screen 1 should say duplicate'
        );
    ...
    },
    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(
          $('#divApplab').children().length,
          2,
          'code mode has two screen divs'
        );
        assert.equal(
          $('#divApplab #screen1 #button1').length,
          1,
          'code mode screen1 contains button1'
        );
        assert.equal(
          $('#divApplab #screen2 #button2').length,
          1,
          'code mode screen2 contains button2'
        );
        ...
        assert.equal(
          $('#designModeViz').children().length,
          2,
          'design mode has two screen divs'
        );
        assert.equal(
          $('#designModeViz #design_screen1 #design_button1').length,
          1,
          'design mode screen1 contains button1'
        );
        assert.equal(
          $('#designModeViz #design_screen2 #design_button2').length,
          1,
        ...
        assert.equal(
          $('#propertiesBody button').first().text(),
          'Delete',
          'first button should be delete'
        );
        ...
        assert.equal(
          $('#propertyRowContainer button').last().text(),
          'Make Default',
          'Third screen should have default button'
        );
        assert.equal(
          $('#propertiesBody button').first().text(),
          'Delete',
        ...
        assert.equal($('#screenSelector').children().length, 5);
        assert.equal(
          $('#screenSelector').children().eq(4).text(),
          'New screen...'
        );
        ...
        assert.equal(
          $('#designModeViz').children().length,
          4,
          'has four screen divs'
        );
        assert.equal($('#screenSelector').children().length, 6);
        assert.equal(
          $('#propertyRowContainer button').last().text(),
          'Make Default',
          'New screen should have default button'
        );
        assert.equal(
          $('#propertiesBody button').first().text(),
          'Delete',
    ...
    {
      description:
        'can load an run a level with bogus nested screens without javascript error',
      editCode: true,
      xml:
        'setScreen("screen2");\n' +
