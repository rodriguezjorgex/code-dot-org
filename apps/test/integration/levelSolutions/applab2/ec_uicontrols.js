  ...
  tests: [
    ...
    // up with any errors
    {
      ...
      xml:
        ...
        'getChecked("id5")\n' +
        'setChecked("id5", true);\n' +
        'image("id7", "/blockly/media/logo.png");\n' +
        'getImageURL("id7");\n' +
        'setImageURL("id7", "/blockly/media/logo.png");\n' +
        ...
        tickWrapper.runOnAppTick(Applab, 2, function () {
          assert(
            document
              ...
              .getAttribute('data-object-fit') === 'cover'
          );
          assert(
            document
              .getElementById('idImage3')
              .getAttribute('data-object-fit') === 'contain'
          );
          Applab.onPuzzleComplete();
        });
      },
    ...
    },
    {
      ...
      customValidator: function (assert) {
        ...
        assert(
          ...
          'No button named runButton should appear in applab'
        );
        return true;
      },
      expected: {
    ...
    },
    {
      ...
      customValidator: function (assert) {
        ...
        assert(
          ...
          'No button named submitButton should appear in applab'
        );
        return true;
      },
      expected: {
    ...
    },
    {
      ...
      xml:
        ...
        '  </select>' +
        '  <a href="/blockly/media/logo.png">logo</a>' +
        '</div>' +
        "')\n;",
      ...
      runBeforeClick: function (assert) {
        ...
        tickWrapper.runOnAppTick(Applab, 2, function () {
          ...
          assert.equal(
            ...
            expectedHtml,
            'container has unexpected outerHTML'
          );
    ...
    {
      description:
        'cosmetic changes in html sanitization do not cause warnings',
      timeout: 20000,
      editCode: true,
      xml:
        '' +
